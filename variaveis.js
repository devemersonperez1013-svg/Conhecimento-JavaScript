...
// let é a variavel mais novo do var. let é mais organizado e respeita limites onde foi declarado.
// Se for declarado em um if, fora dele ninguem vai conhecer. So fica na area dele
// Exemplo:
if (true) {
    let exemploLet = "Só existo aqui dentro, tá?"
}
console.log(exemploLet) // Não vai funcionar essa chamada
...
// Não funciona ao declarar na variavel: let 1nome -> não vai dar certo; 
...
let _idade = 20
let $dinheiro = "pouco"
let temDuvidas = "Deixe um comentario"
...
// No Case Sensitive, douas variaveis com o mesmo nome pode gerar erro, mas...
...
// String: São textos, tudo o que esta entre aspas vira String (seja aspas simples ou duplas)
let nome = "JavaScript"
...
// Boolean: Só há dois valores, true (verdade), e false (falso), é como sim e não na linguagem
let amoCodar = true
